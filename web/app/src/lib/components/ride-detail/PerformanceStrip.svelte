...
<div class="perf-strip animate-in">
  {#if hasPower}
    <div class="perf-group">
      <svg class="group-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M13 2 3 14h9l-1 8 10-12h-9l1-8z"/></svg>
      {#if ride.power_avg > 0}
        <div class="perf-chip">
  ...
  {#if hasHr}
    <div class="perf-group">
      <svg class="group-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4.05 3 5.5l7 7Z"/></svg>
      {#if ride.hr_avg > 0}
        <div class="perf-chip">
  ...
  {#if hasElevation}
    <div class="perf-group">
      <svg class="group-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m8 3 4 8 5-5 5 15H2L8 3z"/></svg>
  ...
  {#if hasCadence}
    <div class="perf-group">
      <svg class="group-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 12a9 9 0 1 1-9-9c2.52 0 4.93 1 6.74 2.74L21 8"/><path d="M21 3v5h-5"/></svg>
      <div class="perf-chip">
  ...
  {#if hasSpeed}
    <div class="perf-group">
      <svg class="group-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><polyline points="12 8 12 12 14 14"/></svg>
  ...
  {#if hasEnergy}
    <div class="perf-group">
      <svg class="group-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><circle cx="12" cy="12" r="4"/></svg>
      <div class="perf-chip">
...
<style>
  ...
  @media (max-width: 768px) {
    .perf-strip { padding: 8px 10px; gap: 5px; }
    .perf-chip { padding: 4px 7px; }
    .perf-val { font-size: 14px; }
    .perf-unit { font-size: 10px; }
    .group-icon { width: 13px; height: 13px; }
  }
</style>
